...
from hog_server.database import (
    get_device_id,
    get_type_id,
    add_measurement,
    init_db,
    close_db,
    update_custom_device_name,
)
...
def create_app(test_config=None):
    ...
    def new_measurement():
        ...
        try:
            custom_device_name = data["custom_device_name"]
        except:
            pass
        ...
        if custom_device_name:
            update_custom_device_name(device_id, custom_device_name)
